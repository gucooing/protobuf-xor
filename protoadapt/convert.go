...
// MessageV2 is the [github.com/gucooing/protobuf-xor/proto.Message] type used by the
// current [github.com/gucooing/protobuf-xor] module, adding support for reflection.
