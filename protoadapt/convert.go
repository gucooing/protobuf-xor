...
// MessageV2 is the [github.com/gucooing/zzz/protobuf/proto.Message] type used by the
// current [github.com/gucooing/zzz/protobuf] module, adding support for reflection.
