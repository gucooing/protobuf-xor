...
//
//	go build -ldflags "-X github.com/gucooing/protobuf-xor/reflect/protoregistry.conflictPolicy=warn"
//
...
func (r *Files) checkGenProtoConflict(path string) {
	...
	currPath := "github.com/gucooing/protobuf-xor/types/known/" + pkgName
	panic(fmt.Sprintf(""+
